...
export const ROUTES:Routes = [authRoute,userRoute,courseRoutes,courseenrollmentRoutes,coursematerialRoutes,assignmentRoutes,announcementRoutes,submissionRoutes]